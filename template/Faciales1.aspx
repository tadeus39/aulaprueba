<%@ Page Title="" Language="C#" MasterPageFile="~/mpUno.master" AutoEventWireup="true" CodeFile="Faciales1.aspx.cs" Inherits="Faciales1" %>
            ...
            <div class='selector'>
                <ul>
                    <li>
                        ...
                        <img id='c1' src="images/Faciales/CureFacial.jpg" height="150" width="150" style="transform: rotate(0deg)" />
                    </li>
                    <li>


                        <img id='c2' src="images/Faciales/AntiEdad.jpg" height="150" width="150"  style="transform: rotate(330deg)" />
                    </li>
                    <li>


                        <img id='c3' src="images/Faciales/Citrica.jpe" height="150" width="150"  style="transform: rotate(300deg)"  />
                    </li>
                     <li>


                        <img id='c4' src="images/Faciales/Accua.jpg" height="150" width="150"  style="transform: rotate(270deg)" />
                    </li>
                    <li>


                        <img id='c5' src="images/Faciales/Acne.jpg" height="150" width="150"  style="transform: rotate(240deg)"  />
                    </li>
                    <li>


                        <img id='c6' src="images/Faciales/M3n3.jpg" height="150" width="150"  style="transform: rotate(210deg)" />
                    </li>
                    <li>


                        <img id='c7' src="images/Faciales/Oxigeno1.jpg" height="150" width="150"  style="transform: rotate(180deg)" />
                    </li>
                    <li>


                        <img id='c8' src="images/Faciales/relajante1.jpg" height="150" width="150"  style="transform: rotate(150deg)" />
                    </li>
                    <li>


                        <img id='c9' src="images/Faciales/hidratante.jpe" height="150" width="150"  style="transform: rotate(120deg)" />
                    </li>
                   <%-- <li>
